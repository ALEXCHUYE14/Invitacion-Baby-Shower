...
export const EVENT = {
  ...
  mapsUrl: 'https://www.google.com/maps/search/?api=1&query=Colegio+de+Ingenieros+del+Peru+Sullana',
  mapsEmbedUrl: 'https://maps.google.com/maps?q=Colegio+de+Ingenieros+del+Peru+Sullana&output=embed',
