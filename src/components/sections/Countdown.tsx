...
function CountdownBox({ value, label }: CountdownBoxProps) {
  return (
    <div className="rounded-2xl border border-gold/30 bg-paper px-1.5 py-4 pb-3 shadow-[0_14px_34px_-26px_rgba(59,55,66,.5)]">
      <div
        key={value}
      ...
      <div className="mx-auto w-full max-w-[560px] px-[clamp(22px,6vw,34px)]">
        ...
        <RevealOnScroll className="relative">
          <div
            ...
            style={{ background: 'radial-gradient(70% 70% at 50% 40%, rgba(227,194,180,.32), transparent 66%)' }}
          />
          {isDone ? (
